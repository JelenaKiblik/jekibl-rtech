...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/ubuntu/jekibl-rtech/src/turtlebot3_simulations/turtlebot3_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/ubuntu/jekibl-rtech/devel)
  ...
  set(turtlebot3_gazebo_INSTALL_PREFIX /home/ubuntu/jekibl-rtech/install)
...
if(NOT "/home/ubuntu/jekibl-rtech/src/turtlebot3_simulations/turtlebot3_gazebo/include " STREQUAL " ")
  set(turtlebot3_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/home/ubuntu/jekibl-rtech/src/turtlebot3_simulations/turtlebot3_gazebo/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ubuntu/jekibl-rtech/src/turtlebot3_simulations/turtlebot3_gazebo/${idir}'.  ${_report}")
    endif()
