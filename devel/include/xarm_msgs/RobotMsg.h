...
struct MD5Sum< ::xarm_msgs::RobotMsg_<ContainerAllocator> >
{
  ...
  {
    return "4ff5202b43a924dfd0a4f28e1ee3e4b7";
  }

  static const char* value(const ::xarm_msgs::RobotMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4ff5202b43a924dfULL;
  static const uint64_t static_value2 = 0xd0a4f28e1ee3e4b7ULL;
};
